        ...
        switch currentScreen
        {
            ...
            case .GAME:
            {
                ...
                if ball.pos.y-ball.r < 0 {
                    ...
                    ball.vel.y = -ball.vel.y*DAMP_WALL
                    rl.PlaySound(strike_fx2)
                } else if rl.CheckCollisionCircleRec({ball.pos.x, ball.pos.y}, ball.r, P1) && ball.vel.x < 0 {
                        p1.hit = true
                ...
                } else if rl.CheckCollisionCircleRec({ball.pos.x, ball.pos.y}, ball.r, P2) && ball.vel.x > 0 {
                        p2.hit = true
                        if rl.IsKeyDown(rl.KeyboardKey.W) {
                            ball.vel.x = -ball.vel.x*DAMP_SPIN
                            ball.vel.y = -ball.vel.y*ACCEL_SPIN
